            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'aliyundocker', passwordVariable: 'apwd', usernameVariable: 'user')]) {
                    // some block
                     ...
                     sh 'docker tag icoding-java-img registry.cn-hangzhou.aliyuncs.com/milianops/icodingdocker:icoding-java-imgv1.0'
                     sh 'docker push registry.cn-hangzhou.aliyuncs.com/milianops/icodingdocker:icoding-java-imgv1.0'
